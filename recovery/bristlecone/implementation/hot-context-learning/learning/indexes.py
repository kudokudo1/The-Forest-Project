...
LEARNING_INDEX_SCHEMA_VERSION = 2
...
class ForestLearningIndexProvider:
    ...
    def __init__(
        ...
        *,
        ...
        # Dependency injection must distinguish an explicitly
        # supplied EMPTY coordinator from no coordinator.
        #
        # Using:
        #
        #     cache_coordinator or CacheCoordinator()
        #
        # can accidentally replace a valid falsey/empty shared
        # coordinator with a private one, fragmenting Warm
        # Forest caches across Tree/Clone callers.
        self.cache = (
            cache_coordinator
    ...
    def _build_operational_index(
        ...
        # This is the global durable generation, not the
        # maximum generation among currently active lessons.
        #
        # Retiring the newest lesson must still advance the
        # freshness clock even though that lesson disappears
        # from the active Warm routing index.
