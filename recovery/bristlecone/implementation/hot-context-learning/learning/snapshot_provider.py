...
class ForestLearningSnapshotProvider:
    ...
    def _canonical_snapshot(
        ...
        def cached_snapshot():
            ...
            # Malformed derived state is disposable.
            self._invalidate_snapshot(
                snapshot_key
            )
        ...
        # Different historical request keys may resolve
        # concurrently to the same exact revision.
        #
        # Canonical publication therefore has its own
        # per-revision single-flight key.
        ...
        try:
            # Recheck after becoming publication leader.
            cached = cached_snapshot()
