...
if OUTPUT.exists():
    raise RuntimeError(
        "L.5 concurrent Pair 3 artifact "
...
print(
    "=== L.5B CONCURRENT MULTI-CONTEXT — PAIR 3 ==="
)
print()
print(
    "Resident before:",
...
print()
print("=== L.5B CONCURRENT PAIR 3 RESULT ===")
print()
