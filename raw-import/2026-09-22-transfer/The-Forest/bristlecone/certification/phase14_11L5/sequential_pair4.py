...
if OUTPUT.exists():
    raise RuntimeError(
        "L.5 sequential pair 4 artifact "
        "already exists."
    )
...
print("=== L.5A SEQUENTIAL MULTI-CONTEXT — PAIR 4 ===")
print()
