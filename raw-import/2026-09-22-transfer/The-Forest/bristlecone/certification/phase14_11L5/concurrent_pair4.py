...
if OUTPUT.exists():
    raise RuntimeError(
        "L.5 concurrent Pair 4 artifact "
...
print(
    "=== L.5B CONCURRENT MULTI-CONTEXT — PAIR 4 ==="
)
print()
print(
    "Resident before:",
...
print()
print("=== L.5B CONCURRENT PAIR 4 RESULT ===")
print()
