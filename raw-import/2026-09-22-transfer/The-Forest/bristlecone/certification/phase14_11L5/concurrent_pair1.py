...
if OUTPUT.exists():
    raise RuntimeError(
        "L.5 concurrent Pair 1 artifact "
...
print(
    "=== L.5B CONCURRENT MULTI-CONTEXT — PAIR 1 ==="
)
print()
print(
    "Resident before:",
...
print()
print("=== L.5B CONCURRENT PAIR 1 RESULT ===")
print()
