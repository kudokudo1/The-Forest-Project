...
if OUTPUT.exists():
    raise RuntimeError(
        "L.5 sequential pair 2 artifact "
        "already exists."
    )
...
print("=== L.5A SEQUENTIAL MULTI-CONTEXT — PAIR 2 ===")
print()
