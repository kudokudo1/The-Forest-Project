...
if OUTPUT.exists():
    raise RuntimeError(
        "L.5 sequential pair 5 artifact "
        "already exists."
    )
...
print("=== L.5A SEQUENTIAL MULTI-CONTEXT — PAIR 5 ===")
print()
