...
if OUTPUT.exists():
    raise RuntimeError(
        "L.5 concurrent Pair 2 artifact "
...
print(
    "=== L.5B CONCURRENT MULTI-CONTEXT — PAIR 2 ==="
)
print()
print(
    "Resident before:",
...
print()
print("=== L.5B CONCURRENT PAIR 2 RESULT ===")
print()
