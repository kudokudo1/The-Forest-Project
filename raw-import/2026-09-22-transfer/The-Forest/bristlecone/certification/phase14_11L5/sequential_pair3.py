...
if OUTPUT.exists():
    raise RuntimeError(
        "L.5 sequential pair 3 artifact "
        "already exists."
    )
...
print("=== L.5A SEQUENTIAL MULTI-CONTEXT — PAIR 3 ===")
print()
