...
SUCCESS_PATH = (
    OUTPUT_DIR
    / "l3_warm_small_trial2_raw.json"
)

IN_PROGRESS_PATH = (
    OUTPUT_DIR
    / "l3_warm_small_trial2_in_progress.json"
)
