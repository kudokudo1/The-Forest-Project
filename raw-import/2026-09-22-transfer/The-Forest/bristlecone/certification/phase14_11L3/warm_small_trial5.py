...
SUCCESS_PATH = (
    OUTPUT_DIR
    / "l3_warm_small_trial5_raw.json"
)

IN_PROGRESS_PATH = (
    OUTPUT_DIR
    / "l3_warm_small_trial5_in_progress.json"
)
