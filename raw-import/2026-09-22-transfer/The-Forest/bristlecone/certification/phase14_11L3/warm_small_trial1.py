...
SUCCESS_PATH = (
    OUTPUT_DIR
    / "l3_warm_small_trial1_raw.json"
)

IN_PROGRESS_PATH = (
    OUTPUT_DIR
    / "l3_warm_small_trial1_in_progress.json"
)
