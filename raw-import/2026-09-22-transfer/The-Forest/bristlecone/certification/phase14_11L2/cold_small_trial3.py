...
SUCCESS_PATH = (
    OUTPUT_DIR
    / "l2_cold_small_trial3_raw.json"
)

IN_PROGRESS_PATH = (
    OUTPUT_DIR
    / "l2_cold_small_trial3_in_progress.json"
)
