...
SUCCESS_PATH = (
    OUTPUT_DIR
    / "l2_cold_small_trial1_raw.json"
)

IN_PROGRESS_PATH = (
    OUTPUT_DIR
    / "l2_cold_small_trial1_in_progress.json"
)
