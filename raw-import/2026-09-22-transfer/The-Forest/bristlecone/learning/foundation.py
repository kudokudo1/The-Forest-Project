...
FOREST_RECORD_SCHEMA_VERSION = 2
...
def _deep_thaw_json(
    ...
    """Convert frozen JSON state to plain JSON containers."""
...
def _deep_freeze_json(
    ...
    """Recursively freeze already-validated JSON state."""
...
def _json_mapping(
    ...
    """Validate and recursively freeze one JSON mapping."""
    ...
    # Thaw first so already-frozen values from an
    # immutable previous revision remain accepted.
    plain = _deep_thaw_json(
        value
    )
...
class ForestLearningRecord:
    ...
    # Positive only for committed Operational Learning
    # revisions. User Context does not advance this counter.
    operational_learning_generation: int = 0
    ...
    def __post_init__(
        ...
        if (
            ...
            raise ForestLearningError(
                "operational_learning_generation must "
                "be an integer >= 0."
            )
    ...
    def create(
        ...
        *,
        ...
        return cls(
            ...
            operational_learning_generation=0,
        )
    ...
    def to_dict(
        ...
        """Return ordinary JSON-compatible durable data."""

        return {
            name: _deep_thaw_json(
                getattr(
                    self,
                    name,
                )
    ...
    def from_dict(
        ...
        return cls(
            ...
            operational_learning_generation=data[
                "operational_learning_generation"
            ],
        )
...
class ForestLearningStore:
    ...
    def _operational_generation(
        ...
        return max(
            (
                record.operational_learning_generation
                for record in records
            ),
            default=0,
        )
    ...
    def get_revision(
        ...
        """Return one exact committed record revision."""
    ...
    def _record_at_generation(
        ...
        *,
        ...
        """Resolve the record revision visible at one generation."""
        ...
        for record in records:
            ...
            if record_domain == "user-context":
                if not record.is_user_context:
                    continue

            elif record_domain == "operational-learning":
                if (
                    record.record_type
                    != "operational-learning"
                ):
    ...
    def get_user_context_at_generation(
        self,
        record_id,
        user_context_generation,
    ):
        """Return User Context exactly as visible at generation N."""
        ...
        with self._locked(
            ...
            return self._record_at_generation(
                records,
                record_id=record_id,
                generation=(
                    user_context_generation
                ...
                record_domain="user-context",
            )


    def get_operational_learning_at_generation(
        self,
        record_id,
        operational_learning_generation,
    ):
        """Return Operational Learning as visible at generation N."""
        ...
        if operational_learning_generation == 0:
            return None
    ...
    def operational_learning_generation(
        self,
    ):
        """Return current durable Operational Learning generation."""
    ...
    def append(
        ...
        with self._locked(
            ...
            operational_generation = (
                self._operational_generation(records)
            )
