...
class TaskSessionManager:
    ...
    def _send_runtime_turn_for_frozen_model_form(
        ...
        *,
        ...
        # D4D1 intentionally performs ONE normal send.
        #
        # A stale-session exception escapes unchanged.
        # D5 will classify it and retry using this exact
        # frozen_turn rather than resolving Model Form again.
        result = sender(
            requested_session_id,
            message,
            execution_state,
        ...
        # Temporary reasoning control may now be consumed.
        reasoning_finalize = (
