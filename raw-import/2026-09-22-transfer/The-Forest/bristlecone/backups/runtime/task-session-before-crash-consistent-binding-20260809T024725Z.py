...
class TaskSessionManager:
    ...
    def send_runtime_turn(
        ...
        Normal same-session turns do not rewrite
        active.yaml. Persistent state changes only
        when a binding is created, imported, or rotated.
        """
